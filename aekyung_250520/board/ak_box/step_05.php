...
$new_content="제목:".$list['hero_title']."\n\n작성일:".date( "Y-m-d", strtotime($list['hero_today']))."\n\n작성자:".$list['hero_nick'];
        echo '                        <div title="'.$new_content.'" align="center">'.PHP_EOL;
        ...
        echo '                            <span class="date"><center>'.date( "Y-m-d H:i", strtotime($list['hero_today'])).'&nbsp;&nbsp;'.$list['hero_nick'].'</center></span>'.PHP_EOL;
        echo '                        </a>'.PHP_EOL;
        echo '                        </div>'.PHP_EOL;
        echo '                    </li>'.PHP_EOL;
$i++;
