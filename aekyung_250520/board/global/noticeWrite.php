...
if($_GET["hero_idx"]) {
	...
	$sql .= " , b.hero_today, b.hero_notice, b.hero_pcMobile, b.hero_temp, m.hero_nick, m.hero_admin_yn ";
...
<div class="contents_area">
	...
	<form name="frm" id="frm" method="POST" enctype="multipart/form-data" action="<?=MAIN_HOME;?>?board=<?=$_GET["board"]?>&view=noticeAction&action=<?=$action?>">
	...
	<div class="contents">		
		...
		<tr>
			...
			<td>
				<img src="<?=$level_icon?>">
				<?=$hero_nick?>
				<input type="checkbox" name="hero_notice" value="1" <?=$view["hero_notice"]==1 ? "checked":"";?> />공지
				<input type="checkbox" name="hero_temp" value="1" <?=$view["hero_temp"]==1 ? "checked":"";?>/>임시글
			</td>
		</tr>
