...
<div class="contents_area">
	...
	<form name="frm" id="frm" method="POST" enctype="multipart/form-data" action="<?=MAIN_HOME;?>?board=<?=$_GET["board"]?>&view=qnaAction&action=<?=$action?>">
	...
	<div class="contents">
		...
		<div class="explainWrap">
			<p style="font-size:14px; font-weight:bold;">고객센터</p> 
			<p class="mgt10" style="line-height:22px; font-size:14px;">
		...
		<div class="btngroup">
			<div class="btn_r">
	 	 		<? if($_SESSION["global_code"]) {?>
		 	 		<? if($view["hero_idx"] && $view["hero_code"] == $_SESSION["global_code"]) {?>
