...
if($_GET["action"] == "write") {
	...
	if($result) {
		message($msg);
		location(PATH_HOME."?board=".$_GET["board"]."&view=reviewList");
	}
	...
	if($result) {
		message($msg);
		location(PATH_HOME."?board=".$_GET["board"]."&view=reviewWrite&hero_idx=".$_POST["hero_idx"]);
	}
	...
	$drop_sql = " UPDATE global_board SET hero_use_yn = 'N' WHERE hero_idx = '".$_POST["hero_idx"]."' ".$where;
