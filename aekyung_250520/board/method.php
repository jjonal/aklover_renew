<link rel="stylesheet" href="../css/front/method.css">

<div class="method_container">
    <h2 class="bold">체험단 참여방법</h2>
    <div class="contents f_sb">
        <ul class="left">
            ...
            <div class="tab_wrap">
                <div class="tab_cont">
                    <div class="description t_c">
                        애경의 다양한 브랜드 제품들을 직접 사용해보고 콘텐츠를 발행하는 체험단입니다.<br />
                        콘텐츠마다 진행 일정이 상이하오니 상세 조건 확인 후 나에게 맞는 체험단을 신청해주세요!
                    </div>
                ...
                <div class="tab_cont">
                    <div class="description t_c">
                        신제품 출시 전 샘플 제품을 충분히 사용해본 후 온라인 설문에 응답하는 체험단입니다.<br />
                        품평 제품에 따라 진행 조건이 상이하오니 상세 조건 확인 후 나에게 맞는 체험단을 신청해주세요!<br />
                        <span class="fz13">* HUT : 가정 내 제품을 일정기간 사용하면서 제품의 성능 및 만족도를 측정하는 조사입니다.</span>
                    </div>
                            ...
                            <ul class="con_list">
                                <li class="con_item f_sb">
                                    <div>
                                        ...
                                        <!-- <p class="sub_des_gray">
                                            * 서포터즈에 따라 상세내용이 상이 할 수 있으니.<br />
                                            반드시 안내사항 숙지 후 신청 부탁드립니다.
                                        </p> -->
                                    </div>
                                    <div>
                ...
                <div class="tab_cont">
                    <div class="description t_c">
                        <!-- 온라인/오프라인 진행 여부는 주제에 따라 결정되며,온라인은 zoom으로 오프라인은 애경본사에서 진행됩니다.<br />
                        제품에 대한 생각과 의견을 대화를 통해 나누는 체험단이므로 반드시 <span class="point">진행 일정(날짜,시간) 확인 후 신청 부탁드립니다.</span> -->
                        ...
                        <span class="fz13">* FGD : 경험을 공유한 사람들이 함께모여 토론하며 의견을 나누는 조사입니다.<br />
                        * FGI : 특정한 경험을 공유한 사람들이 함께모여 인터뷰를 진행하는 조사입니다.</span>  
                    </div>
                ...
                <div class="tab_cont">
                    <div class="description t_c">
                        ...
                        <span class="fz13">*설문조사 : 특정 주제에 대한 결과를 도출하기 위해 설문을 진행하는 조사입니다.</span>
                    </div>
                            ...
                            <ul class="con_list">
                                <li class="con_item f_sb">
                                    <div>
                                        <p class="sub_tit f_cs"><span class="list_num">1</span>설문참여하기</p>
                                        <p class="sub_des">
                                            체험단 상세 페이지 또는 카카오 플러스 친구로 발송된<br />
    ...
    function updateStepBtnListeners() {
        ...
        Array.prototype.forEach.call(stepBtn, function(item){
            item.children[0].addEventListener("click", (e) => {
                ...
                window.scrollTo(0, 240); // 버튼 누르면 스크롤 이동
