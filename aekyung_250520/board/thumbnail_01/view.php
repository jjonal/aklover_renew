...
?>
        ...
        <div class="contents">
            <table border="0" cellpadding="0" cellspacing="0" class="bbs_view">
                ...
                <tr>
                    <td colspan="4" valign="top" width="705px"  class="bbs_view" style="padding:10px;line-height:48px; word-break:break-all;"><?=htmlspecialchars_decode($out_row['hero_command']);?></td><!--677-->
                </tr>
<?
