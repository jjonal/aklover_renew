...
$releaseED = $out_row['hero_today_02_02'];
...
$bestSD = $out_row['hero_today_04_01'];
$bestSD = $yoil[date('w', strtotime($bestSD))];
$bestED = $out_row['hero_today_04_02'];
$bestED = $yoil[date('w', strtotime($bestED))];
?>
<div class="content_date">    
    <div class="mission_guide_btn fz18 main_c bold"><img src="/img/front/board/view.webp" alt="참여방법 보러가기">체험단 참여방법 보러가기</div>
    <!-- 일반미션 (s)-->
