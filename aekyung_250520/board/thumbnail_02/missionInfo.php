...
<div class="content_img_title f_fs">
    <?
    ...
    <div class="content_title">
        <div class="rel content_in">
            ...
            <div class="title_wrap">
                ...
                <p class="top_title fz28 bold"><?=$out_row['hero_title']?></p>
                <p class="top_title2 fz18 fw500"><?=$title_02?></p>
            </div>
            <!-- 일반미션 (s)-->
            <div class="cont_info">
                <p class="fz19 bold">모집정보</p>
                    ...
                    <table>
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td style="width:280px !important;"><?=$out_row['hero_target']?></td>
                            </tr>
                            <tr>
                                <th><img src="/img/front/board/icon02.webp" alt="모집 정보"> 선정인원</th>
                                <td style="width:280px !important;"><?=$out_row['hero_select_count']?></td>
                            </tr>
                            <tr>
                                <th><img src="/img/front/board/icon03.webp" alt="모집 정보"> 선정혜택</th>
                                <td style="width:280px !important;"><?=$out_row['hero_benefit']?></td>
                            </tr>
                        </tbody>
                    </table>
                    <? } else { ?>
                    <table>
                        ...
                        <? if($out_row['hero_benefit_02']){ ?>
                            <tr>
                                ...
                                <td style="width:280px !important;"><?=$out_row['hero_benefit_02']?></td>
                            </tr>
                        <? }?>
                        </tbody>
                    </table>
