...
<?}}?>
						...
						<?php				
							$snsLink = "https://".$_SERVER["HTTP_HOST"]."/main/index.php?board=".$_REQUEST["board"]."&view=step_06&idx=".$_REQUEST["idx"]."&hero_idx=".$_REQUEST["hero_idx"];
							$snsImg = "";
						?>
						<form name="facebookForm" action="https://www.facebook.com/dialog/feed" method="post" target="_blank">
							<input type="hidden" name="app_id" value="1398653377106374">
							<input type="hidden" name="link" value="<?=$snsLink?>">
							<input type="hidden" name="redirect_uri" value="<?=$snsLink?>">
						</form>
						<form name="twitterForm" action="http://twitter.com/share" method="get" target="_blank">
							<input type="hidden" name="url" value="<?=$snsLink?>">
							<input type="hidden" name="text" value="">
						</form>
						<a href="javascript:void(document.facebookForm.submit());">
							<img src="../image/ico_fc.jpg" alt="페이스북공유">
						</a> 
						<a href="javascript:void(document.twitterForm.submit());">
							<img src="../image/ico_tw.jpg" alt="트위터공유">
						</a> 
						<!--a href="javascript:window.open('');">
							<img src="../image/ico_me.jpg" alt="미투데이공유">
						</a-->							
