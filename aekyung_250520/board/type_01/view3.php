...
if(!strcmp($_GET['next_board'],"hero")){
    $hero_table = 'hero';
}else if(strcmp($_GET['next_board'],"")){
    $hero_table = $_GET['next_board'];
}else{
...
setTimeout("window.status=''",1800)
                ...
                <tr>
                    <td colspan="4" valign="top" width="705px"  class="bbs_view" style="padding:10px;line-height:14px; word-break:break-all;"><?=htmlspecialchars_decode($out_row['hero_command']);?></td><!--677-->
                </tr>
