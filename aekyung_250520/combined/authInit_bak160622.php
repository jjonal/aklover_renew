...
$cb_encode_path = FREEBEST_INC_END."CPClient";
//echo "<script>console.log(\"".$cb_encode_path."\")</script>";
$authtype = "M";
$popgubun 	= "N";
$customize 	= "";
$reqseq = `$cb_encode_path SEQ $sitecode`;
$returnurl = FREEBEST_HOME."?hero=hp_ok";
$errorurl = FREEBEST_HOME."?hero=hp_no";
...
$sReturnURL = FREEBEST_HOME."?hero=ip_ok";
