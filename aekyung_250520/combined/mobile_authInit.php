...
//운영
$returnurl = "https://www.aklover.co.kr/freebest/mobile_hp_ok.php";
$errorurl = "https://www.aklover.co.kr/freebest/mobile_hp_no.php";

//musign 테스트
//$returnurl = "http://aklover-test.musign.kr/freebest/mobile_hp_ok.php";
//$errorurl = "http://aklover-test.musign.kr/freebest/mobile_hp_no.php";

//로컬
//$returnurl = "http://localhost/freebest/mobile_hp_ok.php";
//$errorurl = "http://localhost/freebest/mobile_hp_no.php";

//$returnurl = "http://www.aklover.co.kr/freebest/mobile_hp_ok.php";
//$errorurl = "http://www.aklover.co.kr/freebest/mobile_hp_no.php";

//$returnurl = "http://192.168.25.28/freebest/mobile_hp_ok.php";
//$errorurl = "http://192.168.25.28/freebest/mobile_hp_no.php";
...
//$sReturnURL = "http://aklover-test.musign.kr/freebest/ip_ok.php";//musign 테스트
