...
?>
        ...
        <? if($board == "group_04_06" || $board == "group_04_28") { // 뷰티클럽 || 라이프클럽 ?>
        <div class="authPage">
        ...
        <div class="authPage">
    		<div class="noAuthPage">
    			<div><img src="/img/front/pointmall/season2/pointmall.png" alt="포인트 축제 배너" /></div>
    			...
    			<div class="con_box">
					<div class="inner">
						<div class="desc">
							<ul class="grid_3">
								<li>
									<span class="mini_tit fz17 fw600">일정</span>
									<p class="tit fz26 fw800 f_c">연 2회 게릴라로 깜짝 오픈</p>
									<p class="fz18 fw600">상반기/하반기 각 2회 게릴라 오픈됩니다</p>
									<img src="/img/front/pointmall/season2/icon01.png" alt="포인트 축제 기간 설명">
									<p class="fz15 sub_noti">*포인트 페스티벌 일정 및 대상자는 변동될 수 있습니다.</p>
								</li>
								<li>
									<span class="mini_tit fz17 fw600">배송</span>
									<p class="tit fz26 fw800 f_c">전 회원 무료배송</p>
									<p class="fz18 fw600">배송은 축제 종료 후 일괄 발송됩니다</p>
									<img src="/img/front/pointmall/season2/icon02.png" alt="포인트 축제 기간 설명">
								</li>
								<li>
									<span class="mini_tit fz17 fw600">제품</span>
									<p class="tit fz26 fw800">애경의 다양한 인기 제품<br /> 직접 선택 가능</p>
									<!-- <p class="tit fz26 fw800">매 회 다른 제품 구성</p> -->
									<p class="fz18 fw600">애경의 다양한 제품을 경험해보세요!</p>
									<img src="/img/front/pointmall/season2/icon03.png" alt="포인트 축제 기간 설명">
								</li>
							</ul>
						</div>
						<a href="/main/index.php?board=group_04_33" class="faq_box f_b">						
							<div class="f_cs">
								<p class="fz24 fw600 desc c_white">포인트 페스티벌에 대해 궁금한 점이 있다면 <span class="point">자주 묻는 질문</span>을 통해 확인해보세요!</p>
							</div>
							<img src="/img/front/pointmall/season2/arr_gold.png" alt="faq 안내 사항">	
						</a>
						<div class="noti f_c">
							<span class="mini_tit fz17 fw600">유의사항</span>
							<p class="fz18 fw300 sub_desc">
								- 포인트 페스티벌은 연 2회 진행되며, 진행 일정은 깜짝 공개됩니다.<br />
								&ensp;(상반기 : 이달의 AK Lover 및 프리미어 뷰티/라이프 클럽, 하반기 : 전체 회원 대상)<br />
								- 상반기 진행 후 포인트는 소멸되지 않으며, 하반기 진행 후 남은 포인트는 일괄 소멸됩니다.
							</p>
						</div>
					</div>				
				</div>
   				...
   				<div>
           	    	...
           	    	<div class="bg_explain">
           	    		<dl class="box_explain">
           	    			...
           	    			<dd style="letter-spacing:-1px;">애경 뷰티/생활 신제품 사용 후 영상 제작, 신제품 아이디어 제안, 제품 품평회, 설문조사 등</dd>
           	    			<dt><span>혜택</span></dt>
