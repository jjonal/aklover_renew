...
<div class="youtuberListWrap">
	<ul class="youtuberList">
		...
		while($youtube_list = @mysql_fetch_assoc($out_sql)){
				...
				//$youtube_url = "https://172.217.175.42/youtube/v3/channels?part=statistics,snippet&id=".$channel_id."&key=".$youtubeKey;
				
				$youtube_json = file_get_contents($youtube_url);
				
				//print_r($youtube_json);
				/*
			...
			<a href="https://www.youtube.com/channel/<?=$channel_id;?>" target="_blank">
				<dl>
					...
					<dd>
						...
						<p class="icon"><img src="/image/icon_youtuber.png" alt="icon youtube" width="30" /> 구독</p>
					</dd>
				</dl>
			</a>
		</li>
