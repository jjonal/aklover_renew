...
AnyTime.Converter = function(options)
{
	...
	this.fmt = '%Y-%m-%d %T';
	this.dAbbr = ['일','월','화','수','목','금','토'];
	this.dNames = ['일요일','월요일','화요일','수요일','목요일','금요일','토요일'];
	this.eAbbr = ['BCE','CE'];
	this.mAbbr = [ '1월','2월','3월','4월','5월','6월','7월','8월','9월','10월','11월','12월' ];
	this.mNames = [ '1월','2월','3월','4월','5월','6월','7월','8월','9월','10월','11월','12월' ];
	this.baseYear = null;
