...
$sql .= " INNER JOIN board b ON r.hero_old_idx = b.hero_01 AND b.hero_code = r.hero_code ";
$sql .= " LEFT JOIN mission_url u ON b.hero_idx = u.board_hero_idx ";
$sql .= " WHERE m.hero_use=0 AND r.hero_old_idx='".$_GET['hero_idx']."' AND b.hero_01 = '".$_GET['hero_idx']."'  ".$search;
...
//리스트
$sql  = " SELECT r.hero_idx ";
$sql .= " , r.delivery_point_yn, r.hero_superpass, r.hero_today ";
...
$sql .= " LEFT JOIN mission_url u ON b.hero_idx = u.board_hero_idx ";
$sql .= " WHERE m.hero_use=0 AND r.hero_old_idx='".$_GET['hero_idx']."' AND b.hero_01 = '".$_GET['hero_idx']."' ".$search;
$sql .= " ORDER BY r.hero_idx DESC, FIELD(u.gubun,'naver','insta','cafe','etc') DESC, u.hero_idx ASC ";
...
$(document).ready(function(){
	...
	fnExcel = function() {
		$("#searchForm").attr("action","/loaksecure21/nail/01_03_excel.php").submit();
	}
})
</script>
