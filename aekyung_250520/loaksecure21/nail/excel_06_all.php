...
if($_POST["mode"] == "excelAll") {
	...
	header( "Content-Disposition: attachment; filename=전체기수뷰티클럽_".date("Ymd",time()).".xls" );
	...
	$list_sql .=  " FROM (SELECT hero_code FROM member_gisu WHERE hero_board = 'group_04_06' GROUP BY hero_code) g ";
