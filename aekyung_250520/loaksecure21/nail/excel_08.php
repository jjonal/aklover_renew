...
if($_POST["mode"] == "excel") {
	...
	header( "Content-Disposition: attachment; filename=라이프클럽_".date("Ymd",time()).".xls" );
	...
	$list_sql .=  " FROM ";
	$list_sql .=  " ( SELECT g.gisu ,g.hero_code , g.hero_id, g.hero_nick , m.hero_use, m.hero_name, m.hero_hp, m.hero_mail ";
