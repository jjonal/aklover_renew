...
if($_POST["mode"] == "excel") {
	...
	header( "Content-Disposition: attachment; filename=유튜버회원_".date("Ymd",time()).".xls" );
	...
	$list_sql .=  " FROM ";
	$list_sql .=  " ( SELECT g.gisu ,g.hero_code , g.hero_id, g.hero_nick, g.url, g.channel_name  ";
	$list_sql .=  " , m.hero_use, m.hero_name, m.hero_hp, m.hero_mail ";
