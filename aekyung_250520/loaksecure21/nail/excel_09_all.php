...
if($_POST["mode"] == "excelAll") {
	...
	header( "Content-Disposition: attachment; filename=전체기수유튜버회원_".date("Ymd",time()).".xls" );
	...
	$list_sql .=  " FROM (SELECT hero_code, url, channel_name FROM member_gisu WHERE hero_board = 'group_04_27' GROUP BY hero_code) g ";
	...
	<table width="100%" border="1" cellpadding="1" cellspacing="0">
		...
		?>
			<tr>
				...
				<td class="c"><?=$list["url"];?></td>
				<td class="c"><?=$list["channel_name"];?></td>
