...
<script src="<?=ADMIN_DEFAULT?>/js/scheduler/codebase/dhtmlxscheduler.js" type="text/javascript" charset="utf-8"></script>
<link rel="stylesheet" href="<?=ADMIN_DEFAULT?>/js/scheduler/codebase/dhtmlxscheduler.css" type="text/css" media="screen" title="no title" charset="utf-8">
...
<script type="text/javascript">
	...
	function init() {
		...
		scheduler.attachEvent("onEventDeleted",function(id,ev,is_new){
			...
			var url="<?=ADMIN_DEFAULT?>/title/ajax_save_scheduler.php";
