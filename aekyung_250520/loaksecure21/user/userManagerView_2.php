            ...
            <tr>
                ...
                <td>
                    <div class="search_inner">
                        <input type="text" id="sdate1" name="startDate1" value="<?=$_GET["startDate1"]?>" readonly/>
                        <div class="inner_between">~</div>
                        <input type="text" id="edate1" name="endDate1" value="<?=$_GET["endDate1"]?>" readonly/>
                        <div class="add_icon">
...
<script>
    $(document).ready(function(){
        ...
        //날짜 데이터포맷
        $(function(){
            jQuery("#sdate1, #startdate1").AnyTime_picker( {
                format: "%Y-%m-%d %H:%i:00"
            });

            jQuery("#edate1, #enddate1").AnyTime_picker( {
                format: "%Y-%m-%d %H:%i:00"
            });
        });
