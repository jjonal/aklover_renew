            ...
            <tr>
                ...
                <td>
                    <div class="search_inner">
                        <input type="text" id="sdate3" name="startDate3" value="<?=$_GET["startDate3"]?>" readonly/>
                        <div class="inner_between">~</div>
                        <input type="text" id="edate3" name="endDate3" value="<?=$_GET["endDate3"]?>" readonly/>
                        <div class="add_icon">
...
<script>
    $(document).ready(function(){
        ...
        //날짜 데이터포맷
        $(function(){
            jQuery("#sdate3, #startdate3").AnyTime_picker( {
                format: "%Y-%m-%d %H:%i:00"
            });

            jQuery("#edate3, #enddate3").AnyTime_picker( {
                format: "%Y-%m-%d %H:%i:00"
            });
        });
