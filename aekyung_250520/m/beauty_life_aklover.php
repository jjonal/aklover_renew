    ...
    <div id="subpage" class="aklove_page use_aklover">
                ...
                <div class="tab_wrap">
                    <ul class="tab f_cs">
                        ...
                        <li class="rel">
                            ...
                            <ul class="tab_list">
                                <li><a href="/m/beauty_life_aklover.php" class="fz28 fw600 select">프리미어 서포터즈</a></li>
                    ...
                    <ul class="image_content grid_2">
                        <li>
                            ...
                            <div class="btn_moreview">
                                <a href="/m/mission.php?board=group_04_06">프리미어 뷰티 클럽 자세히 보기</a>
                            </div>
                        </li>
                        <li>
                            <div class="con_image">
                            ...
                            <div class="btn_moreview">
                                <a href="/m/mission.php?board=group_04_28">프리미어 라이프 클럽 자세히 보기</a>
                            </div>
                        </li>
                    </ul>
                </div>
                ...
                <div class="contents right">
                    <ul class="gift_content">
                        <li>
                            ...
                            <div class="gift_info">
                                <div class="gift_info_tit">최우수자 시상<br />(최대 30만원 + AK Lover 포인트 20만점)</div>
                                <p class="gift_info_des">
                                    활동 기간 종료 후, 최종 우수자를 선정하여 <br />
                                    최대 30만원 + AK Lover 포인트 20만점 혜택을 제공합니다.<br />
                                    <span class="gray">*혜택은 1등~3등에게 차등 제공하며,<br /> 숏폼팀은 별도 활동비를 지급합니다.</span>
                                </p>
                            </div>
                            <div class="gift_icon">
                        ...
                        <li>
                            ...
                            <div class="gift_info">
                                ...
                                <p class="gift_info_des">
                                    매월 우수한 콘텐츠를 작성해주신 <br />
                                    ‘이달의 AK Lover’를 선정하여 최대 10만원<br />
                                    상당의 상품권을 드립니다.
                                    <span class="gray">(최대 20명)</span>
                                </p>
                            </div>
                            <div class="gift_icon">
                        ...
                        <li>
                            ...
                            <div class="gift_info">
                                <div class="gift_info_tit">수료자 전원 땡큐 박스 증정 및 수료증 제공<br /> (10만원 상당)</div>
                                <p class="gift_info_des">
                                    프리미엄 서포터즈의 필수 활동 조건을 충족한 분들에게<br />
                                    감사의 마음을 담아 10만원 상당의 애경 제품과<br /> 수료증을 제공합니다.
                        ...
                        <li>
                            ...
                            <div class="gift_info">
                                ...
                                <p class="gift_info_des">
                                    ...
                                    <span class="gray">(상반기 : 이달의 AK Lover 및 프리미어 서포터즈 대상 / <br />하반기 : 전체 회원 대상)</span>
                                </p>
                            </div>
                            <div class="gift_icon">
        ...
        <div class="sub_cont">
            <div class="sub_wrap">
                <div class="left">
                    <div class="content_info">
                        <h3><span class="step">Step.3</span>프리미어 뷰티/라이프 클럽 포인트 제도 알아보기</h3>
                        <p>
                    ...
                    <ul class="point_contents">
                                    ...
                                    <li class="grid_custom g2">
                                        ...
                                        <div class="tb_inner">
                                            <div class="grid_custom g2_2 padd_1b">
                                                ...
                                                <div class="tb_inner no_line">
                                                    <div class="grid_custom g2_3 ti no_line">
                                                        <div>블로그 <span class="fz20 gray db">(해당 팀/해당 팀 外)</span></div>
                                                        <div class="no_line">+ 2,500</div>
                                                    </div>
                                                    <div class="grid_custom g2_3 ti no_line">
                                                        <div>인스타그램 <span class="fz20 gray db">(해당 팀/해당 팀 外)</span></div>
                                                        <div class="no_line">+ 2,000</div>
                                                    </div>
                                                    <div class="grid_custom g2_3 ti no_line">
                                                        <div>숏폼 영상<br />(릴스/숏츠/틱톡 등) <span class="fz20 gray db">(해당 팀)</span></div>
                                                        <div class="no_line">+ 2,000</div>
                                                    </div>
                                                    <div class="grid_custom g2_3 ti no_line">
                                                        <div>숏폼 영상<br />(릴스/숏츠/틱톡 등) <span class="fz20 gray db">(해당 팀 外)</span></div>
                                            ...
                                            <div class="grid_custom g2_2 padd_1">
                                                ...
                                                <div class="tb_inner no_line">
                                                    <div class="grid_custom g2_3 ti no_line">
                                                        <div>*상위노출 <span class="fz20 gray db">(~ 5위 / 각 키워드 별)</span></div>
                                                        <div class="no_line">+ 1,500</div>
                                                    </div>
                                                    <div class="grid_custom g2_3 ti no_line">
                                    ...
                                    <li class="grid_custom g2">
                                        ...
                                        <div class="tb_inner">
                                            ...
                                            <div class="grid_custom g2_2 padd_1">
                                                ...
                                                <div class="tb_inner no_line">
                                                    <div class="grid_custom g2_3 ti no_line">
                                                        <div>착불 지급 or 포인트 차감 中 선택 가능 <span class="fz20 gray db">(베이직 미션에 한 함)</span></div>
                                                        <div class="no_line">- 1,000</div>
                                                    </div>
                                                </div>
                                            </div>
                        ...
                        <li>
                            ...
                            <!-- <div class="point_notice">
                                ...
                                <ul class="pn_content">
                                    <li>                                        
                                        블로그, 인스타그램, 숏폼(릴스/틱톡/쇼츠/네이버모먼트)<br />
                                        각 매체별로 컨텐츠 1건씩만 인정됩니다.
                                        <p class="pn_des">
                                            ex. A회원이 본인 소유 블로그a, 블로그b에 컨텐츠 작성 → 블로그 1건만 적립<br />
                                            B회원이 본인 소유 블로그a, 인스타그램a, b에 컨텐츠 작성 → 블로그 1건, 인스타 1건 적립<br />
                                            C회원이 본인 소유 블로그a, 인스타그램a(이미지 1건, 릴스 1건) 컨텐츠 작성<br />
