...
<form name="frm" id="frm" method="POST" action="globalNoticeAction.php?board=<?=$_GET["board"]?>&action=drop">
...
<div class="viewWrap">
	<div class="titleBox">
		...
		<p class="txt_nick"><img src="<?=$level_icon?>" /><a href="javascript:;" onClick="fnProfile('<?=encrypt($view['member_idx']);?>')"><?=$view['hero_nick'];?></a> 
...
function fnEdit(){
	$("#searchForm").attr("action","globalNoticeWrite.php").submit();	
}
