...
<div class="writeWrap"> 
<form name="frm" class="form-horizontal" role="form" enctype="multipart/form-data" method="post" action="globalQnaAction.php?board=<?=$_GET["board"];?>&action=<?=$action?>&page=<?=$page;?>">
...
<div class="form-group">
	...
	<div class="col-sm-10">		
		<input type="text" name="hero_nick" id="hero_nick" title="작성자" value="<?=$_SESSION["global_nick"];?>" readonly class="form-control"/>
	</div>
</div>
...
<div class="mgt10">
	<p style="font-size:13px; font-weight:bold; margin:0;">고객센터</p> 
	<p class="mgt5" style="line-height:18px; font-size:13px;">
		문의전화 : 080-024-1357(수신자 부담)<br>
