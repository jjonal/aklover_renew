...
<div id="list_btn" style="width:90%; margin:auto; margin-top:20px; margin-bottom:20px">
        <ul style="width:100%">
        	...
        	<li style="width:40%; float:left">
            	<a href="<?=DOMAIN_END."m/greatReview.php?".get("hero_idx")?>"><img src="img/review/list_btn.jpg" alt="목록" width="70px"/></a>
        	</li>
        	...
        	<li style="width:60%; float:right; text-align:right">
				<?if( ($_SESSION['temp_level']>='9999') or (!strcmp($board_list['hero_code'],$_SESSION['temp_code'])) ){?>
					...
					<? if($_GET['board'] == "group_04_05" || $_GET['board'] == "group_04_06" || $_GET['board'] == "group_04_07" || $_GET['board'] == "group_04_23" || $_GET['board'] == "group_04_27" || $_GET['board'] == "group_04_28") {?>
