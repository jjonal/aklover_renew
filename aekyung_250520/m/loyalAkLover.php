...
<div class="loyalWrap">
	<p class="titleText mgt10"><span class="titleLine">l</span><?=$hero_month?> Loyal AK LOVER</p>
	...
	<p class="titleText mgt30"><span class="titleLine">l</span>Loyal AK LOVER 선정기준</p>
...
- 3개월 내 Loyal AK LOVER 선정자 제외<br/>
	...
	<p class="titleText mgt30"><span class="titleLine">l</span>Loyal AK LOVER 혜택</p>
...
function fnView(hero_idx) {
	...
	$("#frm").attr("action","loyalAkLoverView.php").submit();
}
</script>