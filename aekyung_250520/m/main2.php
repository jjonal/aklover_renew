...
<!--컨텐츠 시작-->        
   ...
   <div id="tab"  style="background-image:url(img/tab_bg1.jpg); background-repeat:repeat-x;">
      ...
      <li style="background-image:url(img/tab_bg1.jpg); background-repeat:repeat-x; width:19%"><a href="<?=DOMAIN_END?>m/main1.php#tab"><p>핫이슈</p></a></li>
      <li style="background-image:url(img/tab_bg1_1.jpg); background-repeat:repeat-x; width:24%"><a href="<?=DOMAIN_END?>m/main2.php#tab"><p>생생후기</p></a></li>
...
<?
$sql = 'select * from board where hero_table in (\'group_04_05\', \'group_04_06\', \'group_04_07\', \'group_04_08\', \'group_04_09\') order by hero_today desc limit 0,5';
...
?>
        <a href="<?=DOMAIN_END?>m/board_view_01.php?board=<?=$main_list['hero_table']?>&page=1&hero_idx=<?=$main_list['hero_idx']?>">
        <ul style="width:100%">
          <li class="list_left"><img src="<?=str($pk_row['hero_img_new'])?>" height="13px" />&nbsp;<?=$pk_row['hero_nick'];?></li>
          <li class="list_center"><p><?=$new_img_view?>&nbsp;<?=$title_01?></p></li>
