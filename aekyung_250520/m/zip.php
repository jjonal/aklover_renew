...
if(!strcmp($_POST['type'],'zip')){
    if(strcmp($_POST['input_chat'],'')){
        ...
        while($list  = @mysql_fetch_assoc($out_sql)){ 
            $out .= '<p style="cursor:pointer;" onclick="fnLoad_01(\''.$list['zipcode'].'\', \''.$list['sido'].'\', \''.$list['gugun'].'\', \''.$list['dong'].'\', \''.$list['bunji'].'\', \''.$list['seq'].'\')">'.$list['gugun'].' '.$list['dong'].' '.$list['bunji'].'</p>';//.' '.$list['seq']
        }
