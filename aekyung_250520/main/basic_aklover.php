                ...
                <ul class="tab f_c">
                    ...
                    <li class="rel">
                        ...
                        <ul class="tab_list">
                            ...
                            <li><a href="/main/basic_aklover.php" class="fz18 fw600 select">베이직 서포터즈</a></li>
                                    ...
                                    <div class="tb_inner">
                                        <div class="grid_custom g2_2 padd_1b">
                                            ...
                                            <div class="tb_inner no_line">
                                                ...
                                                <div class="grid_custom g2_3 ti no_line">
                                                    <div>필수 콘텐츠 발행 <span class="fz14 gray">(각 미션 별)</span></div>
                                                    <div class="no_line">+ 500</div>
                                                </div>
                                                <div class="grid_custom g2_3 ti no_line">
                                                    <div>*헬로스타터 <span class="fz14 gray">(최초 발행 1회)</span></div>
                                                    <div class="no_line">+ 500</div>
                                                </div>
                                                <div class="grid_custom g2_3 ti no_line">
                                                    <div>페널티 미 적용 <span class="fz14 gray">(각 미션 별)</span> </div>
                                                    <div class="no_line">+ 500</div>
                                                </div>
                                                <div class="grid_custom g2_3 ti no_line">
                                                    <div>우수자 <span class="fz14 gray">(각 미션 별)</span></div>
                                                    <div class="no_line">+ 4,000</div>
                                                </div>
                                                <div class="grid_custom g2_3 ti no_line">
                                                    <div>준 우수자 <span class="fz14 gray">(각 미션 별)</span></div>
                                ...
                                <li class="grid_custom g2">
                                    ...
                                    <div class="tb_inner">
                                        ...
                                        <div class="grid_custom g2_2 padd_1">
                                            ...
                                            <div class="tb_inner no_line">
                                                <div class="grid_custom g2_3 ti no_line">
                                                    <div>착불 지급 or 포인트 차감 中 선택 가능</div>
                                                    <div class="no_line">- 1,000</div>
                                                </div>
                                            </div>
                                        </div>
