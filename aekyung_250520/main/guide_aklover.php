    ...
    <div class="sub_title">
        <div class="sub_wrap">
            <div class="f_b">
                ...
                <ul class="tab f_c">
                    <li><a href="/main/guide_aklover.php" class="fz18 fw600 on">홈페이지 편</a></li>
                    <li class="rel">
                        <a class="fz18 fw600 tab_btn">서포터즈 편 <img src="/img/front/intro/arrow_white.webp" alt="화살표" class="black"/></a>
                        <ul class="tab_list">
        ...
        <div class="sub_wrap board_wrap f_sb">
            <div class="left">
                <div class="content_info">
                    ...
                    <p>
                        AK Lover 홈페이지에 가입하시면<br />
                        다양한 활동과 혜택을 즐길 수 있습니다.
                    </p>
                </div>
            </div>
            <div class="right">
            ...
            <div class="right">
                <ul class="image_content grid_2">
                    <li>
                        ...
                        <p class="cont_des">‘마이페이지 > 내 정보 변경‘을 통해 프로필 사진 변경이 가능합니다.</p>
                    </li>
                    <li>
                        <div class="con_image">
                    ...
                    <li class="profile">
                        ...
                        <div class="btn_moreview">
                            <? if($_SESSION['temp_code']=='' && !$_SESSION["global_code"]){?>   <!-- 비로그인 -->
                                <a href="/main/index.php?board=login">프로필 완성하러 가기</a>
                            <? }else{ ?>
                                <a href="/main/index.php?board=infoauth">프로필 완성하러 가기</a>
                                <!-- <a href="/main/index.php?board=group_04_03&page=1&view=view&idx=443487">프로필 완성하러 가기</a> -->
                            <? } ?>
                        </div>
                    </li>
                </ul>
        ...
        <div class="sub_wrap board_wrap f_sb">
            ...
            <div class="right">
                <ul class="look_content">
                    ...
                    <li class="f_fs">
                        <div class="lc_image">
                            <img src="/img/front/intro/browse_page_2.jpg" alt="포인트 축제" />
                        </div>
                        <div class="lc_des">
                            <h3>
                            ...
                            <p>
                                ...
                                <span class="fz15 gray">(상반기 : 이달의 AK Lover 및 프리미어 대상 / 하반기 : 전체 회원 대상)</span>
                            </p>
                        </div>
                    </li>
                    <li class="f_fs">
