...
<?}?>
            <a href="#" class="rollbtn rbtn1"><img src="../image/main/benner_left_bt.png" alt="이전"></a>
            <a href="#" class="rollbtn rbtn2"><img src="../image/main/benner_right_bt.png" alt="다음"></a>
...
?>
            <a href="<?=url($other_01_list['hero_href'])?>"></a>
        </div>
        <div class="blog_cnt">
            <ul class="blog_type">
...
/*
$img_host 값은 aklover.co.kr
$list_00['hero_img_new'] 값은 https://aklover.co.kr:11486/user/photo/2014_02/temp_2014_02_18_04_58_50_mhh1mlkG3M1MTDWvIllhc9csr7nr.jpg
$HTTP_SERVER_VARS['HTTP_HOST'] 값은 aklover.co.kr:11486

변경하고자한다면 $img_host값이 null일때 $view_img = $list_00['hero_img_new'];
*/
...
$img_host = $img_parser_url['host'];
    if(!strcmp($list_00['hero_img_new'],'')){
        ...
        $view_img = IMAGE_END.'hero.jpg';
//       $view_img = DOMAIN.$list_00['hero_img_new'];
			...
			*/
            if("<?=$temp_count_test?>" > 4){
                $('#slide').slidesjs({
                  ...
                  height: 408,
                  navigation: false,
                  play: { auto: true,interval: 8000, restartDelay: 500}
                });
            }
...
?>
		popup('<?=$popup_list[hero_idx]?>', '/popup/pop02.php?hero_idx=<?=$popup_list[hero_idx]?>', <?=$popup_list[hero_width]?>, <?=$popup_list[hero_height]+20?>, <?=$popup_list[hero_width_point]?>, <?=$popup_list[hero_height_point]?>,'no');//폭/높이/좌측/우측/스크롤
<?}?>
</script>
