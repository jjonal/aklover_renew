...
<div id="subpage" class="aklove_page">
                ...
                <ul class="tab f_c">
                    ...
                    <li class="rel">
                        ...
                        <ul class="tab_list">
                            ...
                            <li><a href="/main/multiclub_aklover.php" class="fz18 fw600 select">베이직 서포터즈</a></li>
            ...
            <div class="contents right">
                <ul class="image_content grid_2">
                    <li>
                        ...
                        <p class="con_tit">
                            <a href="/main/index.php?board=group_04_05">
                                제품 콘텐츠 발행<span class="arrow"><img src="/img/front/intro/diagonal_arrow.webp" alt="화살표" /></span>
                            </a>
                        </p>
                    ...
                    <li>
                        ...
                        <p class="con_tit">
                            <a href="/main/index.php?board=group_04_05">
                                공동 개발<span class="arrow"><img src="/img/front/intro/diagonal_arrow.webp" alt="화살표" /></span>
                            </a>
                        </p>
                        <p class="cont_des">
                ...
                <div class="consumer_content">
                    <p class="con_tit">
                        <a href="/main/index.php?board=group_04_05">
                            소비자 조사<span class="arrow"><img src="/img/front/intro/diagonal_arrow.webp" alt="화살표" /></span>
                        </a>
                    </p>
                    <ul class="grid_4">
                        <li>
                ...
                <ul class="gift_content">
                    ...
                    <li>
                        ...
                        <div class="gift_info">
                            ...
                            <p class="gift_info_des">
                                애경 뷰티/생활용품 직접 체험할 수 있으며, HUT 및 FGD 등 소비자 조사 활동을 통해<br />   
                    ...
                    <li>
                        ...
                        <div class="gift_info">
                            <div class="gift_info_tit">애경 신제품 제공</div>
                            <p class="gift_info_des">
                                콘텐츠 작성을 위하여 애경 신제품을 제공합니다.<br />
                    ...
                    <li>
                        ...
                        <div class="gift_info">
                            ...
                            <p class="gift_info_des">
                                콘텐츠 작성 우수자/준우수자 및 키워드 챌린지 참여자에게 AK Lover 포인트를 제공하며,<br />                                
                                적립된 포인트는 제품 배송비(약 3,400원)로 대체 및 포인트 페스티벌 시 사용 가능합니다.<br />
    ...
    <div class="sub_cont">
        <div class="sub_wrap board_wrap f_sb">
            <div class="left">
                <div class="content_info">
                    <h3><span class="step">Step.3</span>베이직 뷰티&라이프 클럽<br />
                    포인트 제도 알아보기</h3>
                    <p>                        
                                    ...
                                    <div class="tb_inner">
                                        <div class="grid_custom g2_2 padd_1b">
                                            ...
                                            <div class="tb_inner no_line">
                                                ...
                                                <div class="grid_custom g2_3 ti no_line">
                                                    <div>우수자 <span class="fz14 gray">(*각 콘텐츠 별)</span></div>
                                                    <div class="no_line">+ 4,000</div>
                                                </div>
                                                <div class="grid_custom g2_3 ti no_line">
                                                    <div>준 우수자 <span class="fz14 gray">(*각 콘텐츠 별)</span></div>
                                                    <div class="no_line">+ 1,500</div>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="grid_custom g2_1">
                                            <div>키워드 챌린지 참여 <span class="fz14 gray">(*최대 3개)</span></div>
                                            <div class="no_line">+ 1,000</div>
                                        </div>
                                        <div class="grid_custom g2_1">
                                            <div>필수 미션 외 기타 SNS <span class="fz14 gray">(*2차 컨텐츠)</span></div>
                                        ...
                                        <div class="grid_custom g2_2 padd_0">
                                            ...
                                            <div class="tb_inner no_line">
                                                ...
                                                <div id="minus_point" class="grid_custom g2_3 ti no_line">
                                                    <div>원본 활용 <span class="fz14 gray">(본문수정, 신규 촬영 등)</span></div>
                                                    <div class="no_line">5만원 상당<br /> 애경제품 제공</div>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                        ...
                        <div class="table_container t_c club_tb">
                            ...
                            <ul class="table_body">
                                <li class="grid_custom g2">
                                    ...
                                    <div class="tb_inner">
                                        <div class="grid_custom g2_2 padd_1b">
                                            <div class="division color_orange no_line">콘텐츠</div>
                                            <div class="tb_inner no_line">
                                                <div class="grid_custom g2_3 ti no_line">
                                                    <div>미작성</div>
                                                    <div class="no_line">- 2,000</div>
                                        ...
                                        <div class="grid_custom g2_1">
                                            <div>가이드라인 미준수 <span class="fz15 gray">(*수정 안내 후 미수정)</span></div>
                                            <div class="no_line">- 1,000</div>
                                        </div>
                                        <div class="grid_custom g2_1">
                                            <div>제품 배송비 <span class="fz15 gray">(*선택가능)</span></div>
                                            <div class="no_line">- 1,000</div>
                                        </div>
                                    </div>
                                </li>
