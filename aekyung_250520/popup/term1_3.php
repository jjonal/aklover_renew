...
<select onchange="window.location.href=this.value;" class="wr_select">
  <option value="term1_2.php">2024년 7월 8일자 시행령</option>
  <option value="term1_3.php" selected>2017년 4월 20일 시행령</option>
  <option value="term1.php">2012년 8월 25일 시행령</option>
</select>
</div>
</div>
<?php }?>
<p class="fz16 fw500 mb24">(2017년 4월 20일자 시행령)</p>
<h2>제1장 총칙</h2>
<p><strong>제 1조 (목 적)</strong> 이 이용약관(이하 '약관'이라 합니다)은 &quot;애경산업(주)의 AK LOVER사이트 이용 고객(이하 '회원'이라 합니다)간에 회사가 제공하는 애경산업㈜에서 운영하는 웹사이트 웹서비스(이하 '서비스'라 합니다)의 가입조건 및 이용에 관한 제반 사항과 기타 필요한 사항을 구체적으로 규정함을 목적으로 합니다.</p>
...
<p>이 약관에서 사용하는 용어의 정의는 다음과 같습니다. <br />
  ...
  4. 해 지 : 회사 또는 회원이 서비스 이용 이후 그 이용계약을 종료시키는 의사표시 
</p>
...
회원 활동 시 지급되는 포인트는 게릴라로 진행되는 포인트 축제 이후 자동 소멸 됩니다. 단, 회원 자격 및 등급은 계속 유지 됩니다. 
</p>
<h2>제 2장 서비스 이용계약</h2>
...
<p>(2) 회사는 다음과 같은 경우에 법이 허용하는 범위 내에서 회원의 개인정보를 제3자에게 제공할 수 있습니다.
