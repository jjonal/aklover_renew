...
<div class="contents_area mu_member join_wrap">
	...
	<div class="contents">
		<div class="signup_wrap">
				...
				<div class="snsLoginForm t_c">
					<div class="snsBox f_c">
						<form name="form_chk" method="post">
                            ...
                            <a href="javascript:auth.hp_Popup(this.form_chk);" class="btn_lover"><img src="/img/front/member/mobile.webp" alt="휴대폰 인증"></a>
						</form>
						<span class="bar"></span>
					...
					<form name="idcheckForm" id="idcheckForm" method="post" action="/main/index.php?board=signup">
			...
			<div class="kakaplus">
				<p class="fz18 fw600">AK Lover 카카오톡 플러스 친구 안내</p>
				<p class="fz14 fw500 subtit gray07">AKLover에서는 체험단 신규 업로드, 당첨자, 배송, 후기마감, 우수자, 수정요청 등<br>
				모든 커뮤니케이션을 카카오톡 플러스 친구로 진행합니다.<br>
...
<script>
    //네이바
	var naver_id_login = new naver_id_login(naver.client_id,"<?=getSnsDomain()?>/main/index.php?board=idcheck&");
    ...
    var startApp = function() {
        gapi.load('auth2', function(){
            ...
            auth2 = gapi.auth2.init({
                ...
                // cookiepolicy: 'http://aklover-test.musign.kr', //musign 테스트
            });
