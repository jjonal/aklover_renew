	...
	<div class="contents_area join_ok join_wrap mu_member">
        <div class="page_title t_c">
            ...
            <div class="bread">
                <ul class="f_b">
                    ...
                    <li class="joinstep">2.이용약관 동의</li>
        ...
        <div class="contents">
            <div class="maincont">
                ...
                <p class="desc fz20 fw600">
                    <!--!!!!!!!! [개발요청] 가입 아이디 노출 [완]!!!!!!!!  -->
                    <span><?=$_GET["id"]?></span> 님, 회원가입을 축하드립니다!<br />
                    회원가입 완료 후, 다시 로그인이 필요합니다.
                </p>
                <p class="fz12 gray fw600">* 프로필 완성하고 추가 포인트 적립하세요!</p>
                <div>
                    <div class="btn_bx f_c">
						<a class="btn_submit btn_white" href="/">홈화면으로</a>
						<a class="btn_submit btn_black" href="/main/index.php?board=login">로그인 하기</a>
					</div>
                </div>
            </div>
            <a href="/" class="btn_submit btn_main_c btn_guide f_b">
                <span class="fz16 fw600">AK Lover 가 처음이신가요?</span>
                <span class="f_c">이용백서 보러가기 <img src="/img/front/member/arr.webp" alt="화살표"></span>
            </a>
        </div>
    </div>
<script>
