    ...
    <img src="../image/story/story2_t1.gif" alt="" class="logotitle" />
      ...
      <ul class="logolist">
       ...
       <!-- <li><a href="http://www.coolspark.co.kr/" target="_blank"><img src="../image/story/logo6.gif" alt="스파크" /></a></li>
        <li><a href="http://www.sparkmini.co.kr/" target="_blank"><img src="../image/story/logo8.gif" alt="스파크미니" /></a></li>-->
        <li>
        	<a href="http://www.aekyung.co.kr/ak_08/product_list/product_list_03.jsp" target="_blank">
        		<img src="../image/story/logo3.gif" alt="애경울샴푸" />
        	</a>
        	
        </li>
        <li><a href="http://www.aekyung.co.kr/ak_08/product_list/product_list_06.jsp" target="_blank"><img src="../image/story/logo4.gif" alt="트리오" /></a></li>
        <li><a href="http://www.aekyung.co.kr/ak_08/product_list/product_list_05.jsp" target="_blank"><img src="../image/story/logo5.gif" alt="순샘버블" /></a></li>
      ...
      <ul class="logolist">
        <li>
		  ...
		  <li>
        	...
        	<a href="http://www.aekyung.co.kr/ak_08/main/sub.jsp?pcd=health_care%2Fhealth_care_020" target="_blank"><img src="../image/story/logo_health.png" alt="헬스앤" class="logotitle" /></a>
      ...
      <ul class="logolist">        
        <li>
        	...
        	<img src="../image/ico_blog.gif" style="position: relative;top: -22px;left: 117px; cursor:pointer" alt="케라시스" onclick="window.open('http://www.allthatb.com/')"/>
        </li>
      <!--  <li>
        	<a href="http://www.aekyung.co.kr/ak_08/main/sub.jsp?pcd=beauty_care%2Fbeauty_care_010_030" target="_blank"><img src="../image/story/logo15.gif" alt="에스따르" /></a>
        	<img src="../image/ico_fc.jpg" style="position: relative;top: -22px;left: 122px; cursor:pointer" alt="에스따르" onclick="window.open('https://www.facebook.com/Esthaar.BM')"/>
        </li>-->
      ...
      <ul class="logolist">
        ...
        <li>
		 ...
		 <li>
        	<a href="http://www.aekyung.co.kr/ak_08/product_list/product_list_30.jsp" target="_blank"><img src="../image/story/ban_aget.gif" alt="에이지투웨니스"border="0" /></a>
        </li>
		</ul>
	     <img src="../image/story/story2_t4.gif" class="logotitle" />
		<ul class="logolist">
		  <li>
        	<a href="http://www.maumgage.com/shop/main/index.php" target="_blank"><img src="../image/story/barnd_maumgage.gif" alt="맞춤형 선물세트 마음가게"border="0" /></a>
        </li>
		 <li>
        	<a href="http://akbeauty.co.kr/shop/goods/goods_list.php?&category=001" target="_blank"><img src="../image/story/barnd_beautymall.gif" alt="AK 뷰티몰"border="0" /></a>
        </li>      
      </ul>
    </div>
    </div>
